      ...
      <div className="space-y-5">
        ...
        <div className="mx-auto w-48 h-48 rounded-xl bg-white flex items-center justify-center">
          <div className="text-center">
            <div className="w-32 h-32 mx-auto bg-surface rounded-lg grid grid-cols-5 grid-rows-5 gap-0.5 p-2">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 h-10 rounded-lg bg-surface-3 border border-border px-3 flex items-center overflow-hidden">
            <span className="text-xs text-text-tertiary font-mono truncate">{url || `stackpool.app/pool/${poolId}`}</span>
          </div>
          <button
            onClick={handleCopy}
            className="h-10 px-4 rounded-lg bg-surface-3 border border-border text-sm text-text-primary hover:border-border-hover transition-colors shrink-0 cursor-pointer"
          >
            {copied ? "Copied" : "Copy"}
          </button>
        </div>
        ...
        <div className="flex items-center justify-center gap-3">
          <a
            ...
            className="h-10 w-10 rounded-lg bg-[#25D366]/10 border border-[#25D366]/20 flex items-center justify-center text-[#25D366] hover:bg-[#25D366]/20 transition-colors"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="h-10 w-10 rounded-lg bg-white/5 border border-border flex items-center justify-center text-text-secondary hover:bg-white/10 transition-colors"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="h-10 w-10 rounded-lg bg-[#0088cc]/10 border border-[#0088cc]/20 flex items-center justify-center text-[#0088cc] hover:bg-[#0088cc]/20 transition-colors"
